document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что такое гамильтонов путь?",
            answers: [
                "Путь, проходящий по всем ребрам",
                "Путь, проходящий через все вершины ровно один раз",
        ...
        {
            question: "Чем гамильтонов цикл отличается от эйлерова?",
            answers: [
                "Гамильтонов проходит по вершинам, эйлеров — по ребрам",
                "Гамильтонов проходит по ребрам, эйлеров — по вершинам",
                "Гамильтонов требует нечётных степеней",
                "Гамильтонов возможен только в орграфах"
            ],
            correct: 0
        },
        {
            question: "Что утверждает теорема Дирака?",
            answers: [
                "Если все степени ≥ n/2, то граф гамильтонов",
                "Если граф связный, то он гамильтонов",
                "Если граф планарный, то он гамильтонов",
                "Если граф эйлеров, то он гамильтонов"
            ],
            correct: 0
        },
        {
            question: "Какова сложность задачи нахождения гамильтонова пути?",
            answers: [
                "P (полиномиальная)",
                "NP-полная",
                "Логарифмическая",
        ...
        {
            question: "Можно ли гарантировать отсутствие гамильтонова цикла, если условие Дирака не выполнено?",
            answers: [
                "Да, всегда",
                "Нет, это только достаточное условие",
                "Только для графов с n < 5",
                "Только для несвязных графов"
            ],
            correct: 1
        }
    ];
    ...
    function showResults({ results, correctCount, total }) {
        ...
        // в localStorage
        saveTestResult(7, correctCount, total);
    }
