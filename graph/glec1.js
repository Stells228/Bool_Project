    ...
    const testQuestions = [
        {
            ...
            answers: [
                "Множество чисел",
                "Математическая модель из вершин и ребер",
        ...
        {
            question: "Как называется путь, проходящий через все вершины графа ровно один раз?",
            answers: [
                "Эйлеров цикл",
                "Гамильтонов путь",
                "Планарный путь",
        ...
        {
            question: "Что показывает задача про рукопожатия?",
            answers: [
                "Число людей с нечетным числом рукопожатий всегда четное",
                "Число людей с четным числом рукопожатий всегда нечетное",
                "Все люди жмут одинаковое число рук",
                "Нет правильного ответа"
            ],
            correct: 0
        },
        {
            question: "Можно ли решить задачу о домах и колодцах без пересечений?",
            answers: [
                "Да",
                "Нет",
                "Только для 2 домов и 2 колодцев",
                "Только для 4 домов и 4 колодцев"
            ],
            correct: 1
        },
        {
            question: "С чего началась теория графов?",
            answers: [
