document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что такое ориентированное дерево?",
            answers: [
                "Любой орграф без циклов",
                "Орграф с корнем и единственным путем к каждой вершине",
                "Дерево с максимальным числом дуг",
                "Граф с одной вершиной"
            ],
            correct: 1
        },
        {
            question: "Сколько дуг в ориентированном дереве с 10 вершинами?",
            answers: [
                "9",
                "10",
                "45",
        ...
        {
            question: "Какая вершина является корнем?",
            answers: [
                "Вершина с максимальной степенью",
                "Вершина без входящих дуг",
                "Любая вершина дерева",
                "Вершина без исходящих дуг"
            ],
            correct: 1
        },
        {
            question: "Как называется вершина без исходящих дуг?",
            answers: [
                "Корень",
                "Лист",
                "Родитель",
        ...
        {
            question: "Как обычно представляют ориентированное дерево в коде?",
            answers: [
                "Только как список смежности",
                "Только как матрицу смежности",
                "Как список смежности или массив родителей",
                "Только как множество ребер"
            ],
            correct: 2
        }
    ];
    ...
    function showResults({ results, correctCount, total }) {
        ...
        // в localStorage
        saveTestResult(12, correctCount, total);
    }
