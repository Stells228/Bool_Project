document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что происходит при операции стягивания ребра?",
            answers: [
                "Удаляется вершина и все её ребра",
                "Две вершины объединяются в одну",
                "Ребро делится на два новых",
                "Добавляется новая изолированная вершина"
            ],
            correct: 1
        },
        {
            question: "Как обозначается операция удаления вершины v из графа G?",
            answers: [
                "G + v",
                "G / v",
                "G − v",
        ...
        {
            question: "Что делает операция подразбиения ребра?",
            answers: [
                "Удаляет ребро из графа",
                "Вставляет новую вершину в середину ребра",
                "Объединяет два ребра в одно",
                "Меняет направление ребра"
            ],
            correct: 1
        },
        {
            question: "Какая операция оставляет только общие элементы двух графов?",
            answers: [
                "Объединение",
                "Пересечение",
                "Разность",
        ...
        {
            question: "Какая операция может создавать кратные ребра?",
            answers: [
                "Удаление вершины",
                "Добавление ребра",
                "Стягивание ребра",
