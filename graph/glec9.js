document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            ...
            answers: [
                "Присвоение цветов вершинам по алфавиту",
                "Присвоение цветов вершинам так, чтобы смежные вершины имели разные цвета",
                "Раскраска ребер графа в разные цвета",
                "Графическое представление графа с цветами"
            ],
            correct: 1
        },
        {
            question: "Что такое хроматическое число графа?",
            answers: [
                "Количество вершин в графе",
                "Минимальное количество цветов для правильной раскраски",
        ...
        {
            question: "Сколько цветов нужно для раскраски полного графа K₅?",
            answers: [
                "3",
                "4",
                "5",
        ...
        {
            question: "Что утверждает теорема о четырех красках?",
            answers: [
                "Любой граф можно раскрасить в 4 цвета",
                "Любую карту можно раскрасить в 4 цвета",
                "Планарные графы не могут быть раскрашены менее чем в 4 цвета",
                "Хроматическое число не может быть больше 4"
            ],
            correct: 1
        },
        {
            question: "Какое хроматическое число у дерева?",
            answers: [
                "1",
                "2",
                "3",
    ...
    function showResults({ results, correctCount, total }) {
        ...
        // в localStorage
        saveTestResult(9, correctCount, total);
    }
