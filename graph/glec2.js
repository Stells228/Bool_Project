document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что такое граф в формальном определении?",
            answers: [
                "Множество вершин и ребер",
                "Тройка множеств ⟨V, R, I⟩",
                "Пара множеств вершин и ребер",
                "Графическое представление данных"
            ],
            correct: 1
        },
        {
            question: "Какой граф допускает кратные ребра?",
            answers: [
                "Обычный граф",
                "Мультиграф",
                "Псевдограф",
        ...
        {
            question: "Что показывает степень вершины?",
            answers: [
        ...
        {
            question: "Как обозначается полный граф с n вершинами?",
            answers: [
                "P<sub>n</sub>",
                "K<sub>n</sub>",
                "S<sub>n</sub>",
        ...
        {
            question: "Что такое граф-звезда?",
            answers: [
                "Граф, где все вершины соединены",
                "Граф без ребер",
                "Граф, где все ребра выходят из одной вершины",
                "Граф с равными степенями вершин"
            ],
            correct: 2
        }
    ];
    ...
    function showResults({ results, correctCount, total }) {
        ...
        // в localStorage
        saveTestResult(2, correctCount, total);
    }
