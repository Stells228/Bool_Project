document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что такое расстояние между вершинами в графе?",
            answers: [
                "Количество ребер между ними",
        ...
        {
            question: "Что такое эксцентриситет вершины?",
            answers: [
                "Минимальное расстояние до других вершин",
                "Максимальное расстояние до других вершин",
        ...
        {
            question: "Как связаны радиус и диаметр графа?",
            answers: [
                "r ≤ D ≤ 2r",
                "D = 2r",
                "r = D",
        ...
        {
            question: "Где находится центр в графе-звезде?",
            answers: [
                "В центральной вершине",
                "Во всех вершинах",
                "В двух вершинах",
                "В листьях"
            ],
        ...
        {
            question: "Что показывает диаметр графа?",
            answers: [
    ...
    function showResults({ results, correctCount, total }) {
        ...
        // в localStorage
        saveTestResult(13, correctCount, total);
    }
