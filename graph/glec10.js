document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что такое дерево в теории графов?",
            answers: [
        ...
        {
            question: "Сколько ребер в дереве с 10 вершинами?",
            answers: [
                "9",
                "10",
                "11",
        ...
        {
            question: "Что утверждает формула Кэли?",
            answers: [
                "Число ребер равно числу вершин минус один",
                "Количество помеченных деревьев на n вершинах равно nⁿ⁻²",
                "Каждое дерево можно представить кодом Прюфера",
                "В дереве между любыми двумя вершинами ровно один путь"
            ],
            correct: 1
        },
        {
            question: "Какова длина кода Прюфера для дерева с 7 вершинами?",
            answers: [
                "5",
                "6",
                "7",
        ...
        {
            question: "Какое из этих деревьев используется в базах данных?",
            answers: [
    ...
    function showResults({ results, correctCount, total }) {
        ...
        // в localStorage
        saveTestResult(10, correctCount, total);
    }
