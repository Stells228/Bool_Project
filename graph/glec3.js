document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что такое матрица смежности?",
            answers: [
                "Таблица связей вершин и ребер",
                "Квадратная таблица соединений вершин",
        ...
        {
            question: "Как в матрице инцидентности обозначается начало дуги в орграфе?",
            answers: [
                "0",
                "1",
                "-1",
        ...
        {
            question: "Какой способ задания графа наиболее эффективен по памяти для разреженных графов?",
            answers: [
                "Матрица смежности",
        ...
        {
            question: "Какой объем памяти требуется для матрицы смежности?",
            answers: [
                "O(n)",
                "O(n log n)",
                "O(n²)",
        ...
        {
            question: "Для чего наиболее удобна матрица инцидентности?",
            answers: [
                "Для поиска кратчайшего пути",
                "Для анализа связей вершин и ребер",
                "Для хранения весов ребер",
                "Для представления деревьев"
            ],
            correct: 1
        }
    ];
