document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что такое путь в графе?",
            answers: [
                "Множество вершин",
                "Последовательность чередующихся вершин и ребер",
                "Набор изолированных вершин",
                "Граф без циклов"
            ],
            correct: 1
        },
        {
            question: "Чем отличается цепь от произвольного пути?",
            answers: [
                "В цепи нет повторяющихся ребер",
                "В цепи нет вершин",
                "Цепь всегда замкнута",
                "Цепь содержит все вершины графа"
            ],
            correct: 0
        },
        {
            question: "Что такое простая цепь?",
            answers: [
                "Путь без повторяющихся вершин (кроме начала и конца)",
                "Путь минимальной длины",
                "Путь, содержащий все ребра графа",
                "Путь с повторяющимися ребрами"
            ],
            correct: 0
        },
        {
            question: "Когда граф называется связным?",
            answers: [
                "Когда он содержит хотя бы одну вершину",
                "Когда между любыми двумя вершинами есть путь",
                "Когда в нем нет циклов",
                "Когда он ориентированный"
            ],
            correct: 1
        },
        {
            question: "Что означает сильная связность в орграфе?",
            answers: [
                "Между любыми двумя вершинами есть путь в одну сторону",
                "Между любыми двумя вершинами есть пути в обе стороны",
