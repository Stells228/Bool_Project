document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что такое планарный граф?",
            answers: [
                "Граф, который можно раскрасить в 2 цвета",
                "Граф, который можно нарисовать без пересечений ребер",
                "Граф с одинаковыми степенями вершин",
                "Граф без циклов"
            ],
            correct: 1
        },
        {
            question: "Какой граф НЕ является планарным по теореме Куратовского?",
            answers: [
                "K₄",
                "K₅",
                "Дерево",
        ...
        {
            question: "Что утверждает формула Эйлера для плоского графа?",
            answers: [
                "v + r - g = 2",
                "v - r + g = 2",
                "v + r + g = 2",
        ...
        {
            question: "Какое максимальное число ребер может быть в планарном графе с 10 вершинами?",
            answers: [
                "24",
                "30",
                "15",
        ...
        {
            question: "Где применяется теория планарных графов?",
            answers: [
                "Только в математике",
                "В схематике, картографии и визуализации",
                "Только в компьютерных науках",
                "Только в физике"
            ],
            correct: 1
        }
    ...
    function showResults({ results, correctCount, total }) {
        ...
        // в localStorage
        saveTestResult(8, correctCount, total);
    }
