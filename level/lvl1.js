document.addEventListener('DOMContentLoaded', () => {
    ...
    // Обработчики для select (кастомный селект, ибо тут иначе никак)
    ...
    options.forEach(option => {
        option.addEventListener('click', () => {
            selectHeader.querySelector('span:first-child').textContent = option.textContent; //обновление заголовка
    ...
    function resetUI() {
        nativeSelect.value = '';
        selectHeader.querySelector('span:first-child').textContent = 'Select function';
