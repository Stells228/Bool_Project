document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Сколько булевых функций существует для 2 переменных?",
            answers: [
                "4",
                "8",
                "16",
        ...
        {
            question: "Вектор (0110) задаёт функцию от:",
            answers: [
                "2 переменных",
                "3 переменных",
                "4 переменных",
        ...
        {
            question: "Как задают булеву функцию?",
            answers: [
                "только формулой",
                "только графом",
                "вектором, таблицей, формулой",
                "только ДНФ"
            ],
            correct: 2
        },
        {
            question: "Чем является вектор значений?",
            answers: [
                "перечень аргументов",
                "результаты функции на наборах",
                "почка скобок",
                "полином"
            ],
            correct: 1
        ...
        {
            question: "Через сколько значений задаётся булева функция от n аргументов?",
            answers: [
                "n",
                "2n",
                "2^n",
