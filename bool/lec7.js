document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что значит, что множество булевых функций замкнуто?",
            answers: [
                "в нём нет других функций",
                "нельзя добавить новые элементы",
                "оно замкнуто по суперпозиции",
                "содержит только ДНФ"
            ],
            correct: 2
        },
        {
            question: "Что значит, что множество функций полное?",
            answers: [
                "содержит 0 и 1",
                "можно выразить любую булеву функцию",
                "все функции одинаковые",
                "оно линейное"
            ],
            correct: 1
        },
        {
            question: "Сколько классов функций в критерии Поста?",
            answers: [
                "3",
                "4",
                "5",
        ...
        {
            question: "В какой класс входит функция x * y?",
            answers: [
                "L",
                "T0",
                "S",
        ...
        {
            question: "Функция eg(x * y) входит в класс:",
            answers: [
                "T0",
                "M",
                "ни один",
