document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что такое импликанта?",
            answers: [
                "произвольная формула",
                "элемент, не влияющий на результат",
                "конъюнкция, покрывающая часть функции",
                "нулевая строка таблицы"
            ],
            correct: 2
        },
        {
            question: "Что такое простая импликанта?",
            answers: [
                "самая короткая формула",
                "импликанта без лишних переменных",
                "любая конъюнкция",
                "склеенный моном"
            ],
            correct: 1
        ...
        {
            question: "Сокращённая ДНФ — это:",
            answers: [
                "СДНФ без отрицаний",
                "ДНФ, построенная вручную",
                "дизъюнкция простых импликант",
                "ДНФ, построенная по КНФ"
            ],
            correct: 2
        },
        {
            question: "Что делает метод Квайна?",
            answers: [
        ...
        {
            question: "Что показывает таблица покрытия в методе Квайна?",
            answers: [
                "где функция принимает значение 0",
                "какие импликанты покрывают какие наборы",
                "сколько переменных у функции",
