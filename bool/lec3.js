document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что такое остаточная функция?",
            answers: [
                "функция от фиксированного набора",
                "функция с исключённым аргументом",
                "функция при подстановке конкретного значения переменной",
                "нулевая функция"
            ],
            correct: 2
        },
        {
            question: "Как определить фиктивную переменную?",
            answers: [
                "она не входит в ДНФ",
                "значение переменной всегда 0",
                "она не влияет на вес",
                "остаточные по ней совпадают"
            ],
            correct: 3
        },
        {
            question: "Что происходит при склейке двух остаточных?",
            answers: [
                "создаётся функция от меньшего числа переменных",
                "получается линейная функция",
                "возникает таблица истинности",
                "получается исходная функция"
            ],
            correct: 3
        },
        {
            question: "Сколько аргументов в функции после остаточной по одному аргументу?",
            answers: [
                "n",
                "n + 1",
                "n - 1",
        ...
        {
            question: "Функция называется существенной, если:",
            answers: [
                "все переменные существенны",
                "она принимает значение 1",
                "хотя бы один аргумент фиктивен",
                "она выражается в ДНФ"
            ],
            correct: 0
        }
    ];
    ...
    function showResults({ results, correctCount, total }) {
        ...
        // в localStorage
        saveTestResult(3, correctCount, total); 
    }
