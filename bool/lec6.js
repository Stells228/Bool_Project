document.addEventListener('DOMContentLoaded', () => {
    ...
    const testQuestions = [
        {
            question: "Что такое полином Жегалкина?",
            answers: [
                "формула в ДНФ",
                "представление функции как многочлена над GF(2)",
                "логическая таблица",
                "граф функции"
            ],
            correct: 1
        ...
        {
            question: "Какие операции используются в полиноме Жегалкина?",
            answers: [
                "OR и AND",
                "XOR и AND",
                "XOR и OR",
        ...
        {
            question: "Что обозначает моном в полиноме Жегалкина?",
            answers: [
                "сумма переменных",
                "логическая таблица",
        ...
        {
            question: "Как определить линейность функции по полиному?",
            answers: [
                "в нём есть только AND",
                "в нём есть XOR и произведения переменных",
                "в нём нет мономов степени выше 1 ",
                "в нём нет констант"
            ],
            correct: 2
        },
        {
            question: "Сколько различных полиномов Жегалкина может быть у функции?",
            answers: [
                "0",
                "несколько",
                "бесконечно",
